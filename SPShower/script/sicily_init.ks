...
@component{ father:"立绘" name:"立绘前1" width:720 height:720 layer:2 }
@component{ father:"立绘" name:"立绘后1" width:720 height:720 layer:1 }
@component{ father:"立绘" name:"立绘前2" width:720 height:720 layer:2 }
@component{ father:"立绘" name:"立绘后2" width:720 height:720 layer:1 }
@component{ father:"立绘" name:"立绘前3" width:720 height:720 layer:2 }
@component{ father:"立绘" name:"立绘后3" width:720 height:720 layer:1 }
...
@list{ 		father:"履历" name:"履历列表" width:1240 height:620 x:20 y:50 layer:1 max_item:20}
@component{ father:"履历" name:"履历背景" width:1240 height:680 layer:0 y:20 }

// #7 布局视频组件
@pictureBox{  name:"视频" width:1280 height:720 layer:70 }

///////////////////////////////////////////////////////////////////////////////////////

// 填充背景
@component{ name:"背景前" background_image:"data/images/bg_classroom_01.png" }
@component{ name:"背景后" background_image:"data/images/bg_classroom_01.png" }
...
@component{ 
	...
	background_color:0x00FFFFFF
	on_mouse_in:[ @component{ name:"播放声音按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	on_mouse_in:[ @component{ name:"快进按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	on_mouse_in:[ @component{ name:"自动按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	background_y:-26
	on_mouse_in:[ @component{ name:"保存按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	background_y:-26
	on_mouse_in:[ @component{ name:"读取按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	background_y:-26
	on_mouse_in:[ @component{ name:"快速保存按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	background_y:-26
	on_mouse_in:[ @component{ name:"快速读取按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	background_y:-26
	on_mouse_in:[ @component{ name:"履历按钮" background_y:0 } ]
...
@component{ 
	...
	background_color:0x00FFFFFF
	on_mouse_in:[ @component{ name:"退出按钮" background_y:0 } ]
...
@component{ 
	name:"履历" 	 
	catch_scroll_up: [ @list{ name:"履历列表" scroll_delta:-50 } ]
	catch_scroll_down: [ @list{ name:"履历列表" scroll_delta:50 } ]
	on_rclick: [ 
		@include{ file:"script/sicily_backlog_off.ks" } 
		@include{ file:"script/sicily_dialog_on.ks" }
	]
}
@list{ name:"履历列表" clear:true }
...
@说(角色,内容,继续说){
	...
	// 将内容添加到履历
	履历编号++;
	@component{ father:"履历列表" name:"履历" + 履历编号 width:760 height:100 layer:履历编号}
	@textBox{ 
		name:"履历角色" + 履历编号 
		father:"履历" + 履历编号 
		font:"履历字体" 
